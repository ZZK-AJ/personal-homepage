$(function(){
    ...
    var musicImgsData = ['Player/img/bg.jpg','Player/img/bg1.jpg','Player/img/bg2.jpg']    // 图片地址数组
    var musicNameData = ['出山','盗将行'];                   // 歌曲名数组
    var artistNameData = ['花粥','花粥/马雨阳']            // 创作歌手数组
    var musicUrls=['Player/mp3/music1.mp3','Player/mp3/music2.mp3'];// 歌曲mp3数组
